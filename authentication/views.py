...
def signup(request):
    if request.method == "POST":
        # username = request.POST.get('username') --- este es un metodo alternativo a la linea de abajo
        ...
        #esto es para enviar el mail de confirmacion de creacion del usuario
        ...
        """
        # Relacionado a la validación del mail
...
def signin(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            messages.error(request, "Bad Credentials Entered!")
            return redirect('home')
